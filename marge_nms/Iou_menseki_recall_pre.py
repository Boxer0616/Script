...
parser.add_argument('-ou', '--iou_threshold', help = 'Threshold of IoU', type = float, default = 0.3)
parser.add_argument('-s', '--menseki_threshold', help = 'Threshold of IoU', type = int,default = 15000)
...
if __name__ == '__main__':
    ...
    write_csv(looreca,'recalls',max_boxA)
