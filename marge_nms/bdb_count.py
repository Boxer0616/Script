...
parser.add_argument('-x', '--xml', help = 'Path to predict xml directory', type = str, default = './data/val640/val')
...
def culcu(data):
    ...
    #fig = plt.hist(gte, bins=100)
    #plt.show()
    save_plot_path = os.path.join(args.xml,args.name+'n_figure.jpg')
...
if __name__ == '__main__':
    ...
    print(len(label_list_o))
    print(len(cor_label_list))
    #１枚の矩形の数
