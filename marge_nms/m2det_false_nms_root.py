...
parser.add_argument('-p', '--pre_xml',  default = './output-False-nms')
parser.add_argument('-d', '--dir_name', default = 'sfam320-512-800')
...
parser.add_argument('-o', '--out_dir',  default = './output-False-nms/sfam320-512-800-nms')
...
if __name__ == '__main__':
    ...
    for img_path in img_list:
        ...
        # xmlboxを描画
        draw_box(img_path, output_path, all_box_list, category, colors)

        # xmlファイル作成
        create_xml(framename,directory, all_box_list)
