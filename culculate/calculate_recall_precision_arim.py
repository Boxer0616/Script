...
parser.add_argument('-px', '--pre_xml', help = 'Path to predict xml directory', type = str, default = '/var/samba/Last実験結果/3category/512/predict512cop/inference0.3remove')
parser.add_argument('-cx', '--cor_xml', help = 'Path to correct xml directory', type = str, default = '/var/samba/Last実験結果/3category/512/val-remove-edge')
